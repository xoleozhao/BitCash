...
{
    BOOST_CHECK(TestSplitHost("www.bitcash.org", "www.bitcash.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcash.org]", "www.bitcash.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcash.org:80", "www.bitcash.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcash.org]:80", "www.bitcash.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:5723", "127.0.0.1", 5723));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:5723", "127.0.0.1", 5723));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5723", "::ffff:127.0.0.1", 5723));
    BOOST_CHECK(TestSplitHost("[::]:5723", "::", 5723));
    BOOST_CHECK(TestSplitHost("::5723", "::5723", -1));
    BOOST_CHECK(TestSplitHost(":5723", "", 5723));
    BOOST_CHECK(TestSplitHost("[]:5723", "", 5723));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5723", "127.0.0.1:5723"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:5723", "[::]:5723"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
