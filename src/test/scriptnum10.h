...
#ifndef BITCASH_TEST_SCRIPTNUM10_H
#define BITCASH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitcash Core 0.10.0, for cross-comparison.
 */
public:
