...
#ifndef BITCASH_INTERFACES_NODE_H
#define BITCASH_INTERFACES_NODE_H
...
//! Top-level interface for a bitcash node (bitcashd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCASH_INTERFACES_NODE_H
