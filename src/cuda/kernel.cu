...
const auto DUCK_SIZE_A = 60LL;//30
const auto DUCK_SIZE_B = 40LL;//20
...
extern "C" __declspec(dllexport) int __cdecl SetupKernelBuffers() {
...
extern "C" __declspec(dllexport) bool __cdecl FindCyclesOnCudaDevice(
	uint64_t sip_k0, uint64_t sip_k1,
	uint8_t edgebits,
	uint8_t proof_size,
	uint32_t* cycl,
