...
double CConnman::GetGraphPower()
{
    ...
    double seconds_ellapsed = (mining.end_time - mining.start_time) / 1e2;
...
void CNode::copyStats(CNodeStats &stats)
{
    ...
    // Raw ping time is in microseconds, but show it to user as whole seconds (Bitcash users should be well used to small numbers with many decimal places by now :)
...
static void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        std::string strDesc = "Bitcash " + FormatFullVersion();
