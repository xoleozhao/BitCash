...
#ifndef BITCASH_NET_H
#define BITCASH_NET_H
...
/** Maximum length of incoming protocol messages (no message over 144 MB is currently acceptable). */
static const unsigned int MAX_PROTOCOL_MESSAGE_LENGTH = 4 * 36 * 1000 * 1000;
