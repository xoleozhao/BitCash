...
#ifndef BITCASH_WALLET_WALLETDB_H
#define BITCASH_WALLET_WALLETDB_H
...
public:
    ...
    bool WriteNameNick(const std::string& strName,const std::string& strAddress);
...
#endif // BITCASH_WALLET_WALLETDB_H
