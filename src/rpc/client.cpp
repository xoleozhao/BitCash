...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "generate", 1, "maxtries" },
    { "setgenerate", 0, "mine" },
    { "setgenerate", 1, "reduced" },
    { "setgenerate", 2, "gpumining" },
    { "setgenerate", 3, "gpuid" },
    ...
    { "sendtoaddressfromaddress", 2, "amount" },
    { "sendtoaddressfromaddress", 6, "subtractfeefromamount" },
    { "sendtoaddressfromaddress", 7 , "replaceable" },
    { "sendtoaddressfromaddress", 8 , "conf_target" },
