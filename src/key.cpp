...
//Need to limit range, so that addition of a 248 bit BN is possible without overflow
void CKey::DeleteFirstBit()
{
  keydata[0]=keydata[0] & 0x7F;
}
...
bool CKey::VerifyPubKey(const CPubKey& pubkey) const {
    ...
    unsigned char rnd[8];
    std::string str = "Bitcash key verification\n";
