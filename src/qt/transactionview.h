...
#ifndef BITCASH_QT_TRANSACTIONVIEW_H
#define BITCASH_QT_TRANSACTIONVIEW_H
...
public Q_SLOTS:
    ...
    void changedAmount();
    void changedSearch();
    void changedSearchQML(QString search);
    void changeddatefilter(int index);
    void exportClicked();
    void focusTransaction(const QModelIndex&);
    void focusTransaction(const uint256& txid);
};

#endif // BITCASH_QT_TRANSACTIONVIEW_H
