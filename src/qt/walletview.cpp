    ...
    platformStyle(_platformStyle)
{
    ...
    linksPage = new LinksPage(platformStyle);
    nicknamePage = new NicknamePage(platformStyle);
...
void WalletView::setBitcashGUI(BitcashGUI *gui)
{
    if (gui)
    {
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    linksPage->setClientModel(_clientModel);
    miningPage->setClientModel(_clientModel);
    nicknamePage->setClientModel(_clientModel);
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    linksPage->setWalletModel(_walletModel);
    nicknamePage->setWalletModel(_walletModel);
...
void WalletView::gotoNicknamePage()
{
    setCurrentWidget(nicknamePage);
}

void WalletView::gotoLinksPage()
{
    setCurrentWidget(linksPage);
}
