...
#ifndef BITCASH_QT_WALLETVIEW_H
#define BITCASH_QT_WALLETVIEW_H
...
public:
    ...
    void setBitcashGUI(BitcashGUI *gui);
...
public Q_SLOTS:
    ...
    */
    ...
    void unlockWallet();
    /** Ask for passphrase for the wallet */
    bool askpasswordWallet();
