...
Rectangle {
    ...
    Rectangle {
        ...
        Label {
            ...
            x: 58
            y: 13
            text: qsTr("Create a \"paper wallet\" that contains your public and private BitCash addresses you can use to backup your current wallet.")
    ...
    ShadowBox {
      ...
      Rectangle {
        ...
        Text {
            ...
            width: 484
            color: "#d49f26"
            text: qsTr("Your public address is the address you can share with other people. This is used so they can send you BitCash (or you can use your Nickname if you created one). The Private key should NEVER be shared with anyone otherwise they will have access to all your BitCash. The Private key can be used to restore your wallet if you were to lose it.")
            font.weight: Font.DemiBold
            font.family: "Montserrat SemiBold"
            lineHeight: 1.5
    ...
    Text {
        ...
        text: qsTr("Backup your current wallet onto paper")
        font.pixelSize: 20
        font.family: "Montserrat SemiBold"
        font.weight: Font.DemiBold
    }
