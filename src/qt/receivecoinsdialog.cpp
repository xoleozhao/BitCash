...
void ReceiveCoinsDialog::setModel(WalletModel *_model)
{
    ...
    if(_model && _model->getOptionsModel())
    {
        ...
        ui->useBech32->setVisible(false);//model->wallet().getDefaultAddressType() != OutputType::LEGACY);
    }
}
...
void ReceiveCoinsDialog::on_receiveButton_clicked()
{
    ...
    if (address_type != OutputType::LEGACY) {
        address_type = ui->useBech32->isChecked() ? OutputType::BECH32 : OutputType::LEGACY;
    }
...
void ReceiveCoinsDialog::copyURI()
{
    ...
    const QString uri = GUIUtil::formatBitcashURI(submodel->entry(sel.row()).recipient);
