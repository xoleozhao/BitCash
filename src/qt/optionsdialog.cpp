    ...
    mapper(0)
{
    ...
    ui->bitcashAtStartup->setToolTip(ui->bitcashAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcashAtStartup->setText(ui->bitcashAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitcashConfButton->setToolTip(ui->openBitcashConfButton->toolTip().arg(tr(PACKAGE_NAME)));
...
//    ui->unit->setModel(new BitcashUnits(this));
...
void OptionsDialog::on_openBitcashConfButton_clicked()
{
