...
#ifndef BITCASH_QT_SPLASHSCREEN_H
#define BITCASH_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Bitcash Core initialization
...
#endif // BITCASH_QT_SPLASHSCREEN_H
