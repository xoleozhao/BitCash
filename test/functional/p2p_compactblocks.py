...
# TestP2PConn: A peer we use to send messages to bitcashd, and store responses.
...
class CompactBlocksTest(BitcashTestFramework):
    ...
    # This test actually causes bitcashd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitcashd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcashd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcashd will not send blocktxn responses for blocks whose height is
