...
class TxnMallTest(BitcashTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BITC:
        ...
        # First: use raw transaction API to send 1240 BITC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BITC coin each
        ...
        # Node0's balance should be starting balance, plus 50BITC for another
        ...
        # Node0's total balance should be starting balance, plus 100BITC for
