...
"""Verify that starting bitcash with -h works as expected."""
import subprocess

from test_framework.test_framework import BitcashTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcashTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcash with -h for help text")
        ...
        self.log.info("Start bitcash with -version for version information")
