...
* bitcash.conf: contains configuration settings for bitcashd or bitcash-qt
* bitcashd.pid: stores the process id of bitcashd while running
...
* debug.log: contains debug information and general logging generated by bitcashd or bitcash-qt
