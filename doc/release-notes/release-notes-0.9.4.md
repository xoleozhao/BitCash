Bitcash Core version 0.9.4 is now available from:

  https://bitcash.org/bin/0.9.4/
...
this update is incompatible with the Bitcash system and could lead to consensus
forks.

Bitcash Core released binaries from https://bitcash.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcash/+archive/ubuntu/bitcash
- A third-party or self-compiled Bitcash Core

upgrade to Bitcash Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
