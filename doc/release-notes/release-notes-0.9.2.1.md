Bitcash Core version 0.9.2.1 is now available from:

  https://bitcash.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BITC to 0.01 BITC
...
- Fix "Start bitcash on system login"
