Bitcash version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcash/files/Bitcash/bitcash-0.5.4/
...
http://gitorious.org/bitcash/bitcashd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitcash-Qt notifications under Growl 1.3.
Increase required age of Bitcash-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcash properly when installing Bitcash-Qt over it. (Windows)
