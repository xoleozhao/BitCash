Bitcash Core version 0.10.4 is now available from:

  <https://bitcash.org/bin/bitcash-core-0.10.4/>
...
- #6953 `43c2789` Split bitcash-tx into its own package
- #6953 `dfe0d4d` Include bitcash-tx binary on Debian/Ubuntu
