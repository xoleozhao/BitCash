Bitcash Core version 0.13.2 is now available from:

  <https://bitcash.org/bin/bitcash-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcash-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcash-tx to create v2 transactions (btcdrak)
