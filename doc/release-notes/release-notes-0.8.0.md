Bitcash-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcash/files/Bitcash/bitcash-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitcash
...
New/changed settings (command-line or bitcash.conf file)
--------------------------------------------------------
