Download URL: https://sourceforge.net/projects/bitcash/files/Bitcash/bitcash-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BITC fee schedule (users still pay 0.01 BITC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcash00 - #bitcash99
