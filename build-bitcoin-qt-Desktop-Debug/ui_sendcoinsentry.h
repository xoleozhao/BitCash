...
public:
    ...
    BitcashAmountField *payAmount_is;
    ...
    BitcashAmountField *payAmount_s;
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payAmount = new BitcashAmountField(SendCoins);
        ...
        gridLayout->addLayout(horizontalLayoutAmount, 4, 2, 1, 1);
        ...
        gridLayout->addWidget(messageTextLabel, 5, 2, 1, 1);
        ...
        referencelineEdit = new QLineEdit(SendCoins);
        referencelineEdit->setObjectName(QStringLiteral("referencelineEdit"));

        gridLayout->addWidget(referencelineEdit, 3, 2, 1, 1);

        label = new QLabel(SendCoins);
        ...
        payAmount_is = new BitcashAmountField(SendCoins_UnauthenticatedPaymentRequest);
        ...
        payAmount_s = new BitcashAmountField(SendCoins_AuthenticatedPaymentRequest);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The Bitcash address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less bitcashs than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the bitcash: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Bitcash network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("SendCoinsEntry", "Reference line:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
