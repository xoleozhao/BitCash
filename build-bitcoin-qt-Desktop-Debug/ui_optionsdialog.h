...
public:
    ...
    QPushButton *openBitcashConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        bitcashAtStartup = new QCheckBox(tabMain);
        bitcashAtStartup->setObjectName(QStringLiteral("bitcashAtStartup"));

        verticalLayout_Main->addWidget(bitcashAtStartup);
        ...
        openBitcashConfButton = new QPushButton(OptionsDialog);
        openBitcashConfButton->setObjectName(QStringLiteral("openBitcashConfButton"));
        openBitcashConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openBitcashConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcashAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcashAtStartup->setText(QApplication::translate("OptionsDialog", "&Start %1 on system login", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Bitcash client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Bitcash network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Bitcash network through a separate SOCKS5 proxy for Tor hidden services.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        openBitcashConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        openBitcashConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
